...
from youtube_search_requests_py2 import __VERSION__

def help_arguments():
    a = ArgumentParser(description='Search Youtube videos using python requests without Youtube API in python 2')
